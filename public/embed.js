 ...
 * Full-size video widget with collapse/expand + session reset
 */
...
;(() => {
  ...
  class VoiceAgentWidget {
    ...
    createVideoWidget() {
      ...
      video.innerHTML = `
       <source src="/images/embed/4886443_Business_Woman_Young_3840x2160.mp4" type="video/mp4">
      `
    ...
    openChat() {
      ...
      setTimeout(() => {
        ...
        this.container.querySelector("#voice-agent-video").style.display = "none"
      }, 1200)
    }
    ...
    collapse() {
      ...
      this.container.querySelector("#voice-agent-video").style.display = "block"
      this.videoOverlay.style.display = "flex"
    }
    ...
    expand() {
      ...
      this.videoOverlay.style.display = "flex"
      this.videoOverlay.innerHTML = `
        <button id="voice-agent-button mb-10">Talk to Anamika</button>
        <div id="voice-agent-footer">Powered by Lumiverse Solutions</div>
      `
